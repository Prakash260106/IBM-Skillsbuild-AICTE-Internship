...
def _render_topnav():
    ...
    # Brand + page buttons
    cols = st.columns([1.2] + [1] * len(pages) + [1.5, 0.8])

    with cols[0]:
        st.markdown(
            f'<div class="topnav-brand" style="display:flex;align-items:center;gap:8px;padding:2px 0">'  
            f'  <span style="font-size:1.1rem;display:flex;align-items:center;">{TOPNAV_LOGO}</span>'  
            f'  <span style="font-weight:700;color:var(--accent2);font-size:0.95rem">IntegriAI</span>'  
            f'</div>',
            unsafe_allow_html=True,
        )
...
def page_login_landing(cos):
    ...
    st.markdown(
        ...
        f'  <div class="login-hero-icon">{LOGIN_LOGO}</div>'
        f'  <h1>IntegriAI</h1>'
        f'  <p>Academic Integrity Intelligence Platform</p>'
    ...
    st.markdown(
        """
        <div class="landing-nav-pane">
          <div class="landing-nav-title">Application navigation</div>
          <div class="landing-nav-copy">
            Sign in from the sidebar to open these workspaces. The landing page stays focused on
            the product overview while authentication remains in the navigation pane.
          </div>
          <div class="landing-nav-grid">
            <div class="landing-nav-item">
              <div class="landing-nav-icon">📊</div>
              <div class="landing-nav-name">Dashboard</div>
              <div class="landing-nav-desc">Configure grading styles, rubric notes, and score weights.</div>
            </div>
            <div class="landing-nav-item">
              <div class="landing-nav-icon">🔍</div>
              <div class="landing-nav-name">Evaluate</div>
              <div class="landing-nav-desc">Upload submissions and run layered integrity analysis.</div>
            </div>
            <div class="landing-nav-item">
              <div class="landing-nav-icon">🤖</div>
              <div class="landing-nav-name">AI Chat</div>
              <div class="landing-nav-desc">Ask Granite for guidance on grading and interpretation.</div>
            </div>
            <div class="landing-nav-item">
              <div class="landing-nav-icon">📚</div>
              <div class="landing-nav-name">Library</div>
              <div class="landing-nav-desc">Review saved reports and student writing histories.</div>
            </div>
          </div>
        </div>
        """,
    ...
    with center_col:
        st.markdown(
            '<div class="card-glass" style="padding:2rem;animation:fadeIn 0.6s ease;">'
